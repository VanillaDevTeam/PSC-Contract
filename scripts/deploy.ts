...
async function main() {
    ...
    const marketMakerVaultImpl = await hre.viem.deployContract("VanillaMarketMakerVault");
    ...
    const moneyVaultImpl = await hre.viem.deployContract("VanillaMoneyVault");
    ...
    const moneyVaultContract = await ethers.getContractAt("VanillaMoneyVault", moneyVaultAddress);
